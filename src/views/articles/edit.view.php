...
<main>
                ...
                <input type="hidden" name="_method" value="PATCH">
                    ...
                    <div class="shadow sm:overflow-hidden sm:rounded-md">
                        <div class="space-y-6 bg-white px-4 py-5 sm:p-6">
                            <div>
                                <label for="title" class="block text-sm font-medium text-gray-700">Tytul: </label>
                                <div class="mt-1">
                                    <input type="text" name="title" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" value="<?= output($article['title']);?>">
                            ...
                            <label for="title" class="block text-sm font-medium text-gray-700">Treść: </label>
                                <div class="mt-1">
                                    <textarea name="body" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" ><?= output($article['body']); ?></textarea>
  ...
  <div class="mb-3 block w-full">
                ...
                <form id="delete-form" class="hidden" method="POST" action="/articles">
